...
export const PLUGIN_ITEMS_AMOUNT = 10;

const { config, send } = api.configUnit.getList;
...
export const useGetConfigUnitList = (params: Omit<Params, 'page' | 'limit'>, options?: Options) => {
